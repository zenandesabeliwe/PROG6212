...
Users 
Stores the details of every user in the RaceDay system, including user ID, full name, email address, phone number, password and user role. 
Organisers 
...
Categories 
Stores categories for each event. Categories can be based on age, distance and start time. Each category belongs to an event. 
Participants 
...
5. Relationships Between Entities (Microsoft 2026b).
•	A User can be an Organiser. The Organisers table uses userID as a foreign key. 
